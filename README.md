...
- Debian 13 (You should have a bare Debian 13 installation ready)
- Nginx as webserver
...
- In order to synchronize the latest version of the Walk as Jesus App, you need a private key to the user {{ git_user }} which is allowed to synchronize the repository. (Ex. place the private key in /home/walkasjesus/.ssh/id_rsa)
...
`ln -sf /var/www/walkasjesus/version_1.0 /var/www/walkasjesus/current`
...
`cp /var/www/walkasjesus/version_1.0/walkasjesus_website/walkasjesus_website/db.sqlite3 /var/www/walkasjesus/current/walkasjesus_website/walkasjesus_website/db.sqlite3`

And rsync the latest media files to the current path, by example:  
`rsync -av /var/www/walkasjesus/version_1.0/walkasjesus_website/walkasjesus_website/media/ /var/www/walkasjesus/current/walkasjesus_website/walkasjesus_website/media/`

### Playbook Example


#### Configuring the ansible server
To configure the ansible server in order to install the walkasjesus application you can take the following steps:
...
- hosts: 
  ...
  vars:
    ...
    waj_superuser_email: info@walkasjesus.org
